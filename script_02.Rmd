...
#Gov 50 has the following amount of undergrads enrolled
gov_50_enrollment
...
ggplot(ten, aes(y = u_grad, x = fct_reorder(course_title, u_grad))) +
  geom_col(fill = "steelblue") +
  coord_flip() +
  labs(x = "Course Title", 
       y = "Undergrad Enrollment",
       title = "Undergrad Enrollment of Top Ten Enrolled Courses")
```
